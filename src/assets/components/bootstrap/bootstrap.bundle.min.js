...
! function (e, t) {
  ...
  for (var r, n, o, a, c, f, h, u, d, p, m, g, _, v, y, E, b, w, C, T, S, D, I, A, O, N, k, x, P, L, j, H, M, F, W, R, U, B, q, K, Q, Y, V, z, G, J, Z, X, $, ee, te, ne, ie, re, oe, se, ae, le, ce, fe, he, ue, de, pe, me, ge, _e, ve, ye, Ee, be, we = function (i) {
      var t = "transitionend";
    ...
    }(t = t && t.hasOwnProperty("default") ? t.default : t), Ce = (n = "alert", a = "." + (o = "bs.alert"), c = (r = t).fn[n], f = {
      CLOSE: "close" + a,
      CLOSED: "closed" + a,
      ...
      return e.close = function (e) {
        ...
        var n = this;
        if (r(t).removeClass(d), r(t).hasClass(u)) {
    ...
    }, p), Te = (g = "button", v = "." + (_ = "bs.button"), y = ".data-api", E = (m = t).fn[g], b = "active", w = "btn", T = '[data-toggle^="button"]', S = '[data-toggle="buttons"]', D = "input", I = ".active", A = ".btn", O = {
      ...
      e.preventDefault();
      var t = e.target;
      m(t).hasClass(w) || (t = m(t).closest(A)), N._jQueryInterface.call(m(t), "toggle")
    }).on(O.FOCUS_BLUR_DATA_API, T, function (e) {
      var t = m(e.target).closest(A)[0];
      ...
      return e.next = function () {
        ...
        if (r = e === W ? (n = z, i = G, U) : (n = V, i = J, B), l && k(l).hasClass(Q)) this._isSliding = !1;
        else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
          this._isSliding = !0, f && this.pause(), this._setActiveIndicatorElement(l);
          var h = k.Event(q.SLID, {
            relatedTarget: l,
            direction: r,
            from: a,
            to: c
          ...
          if (k(this._element).hasClass(Y)) {
            ...
            var d = we.getTransitionDurationFromElement(s);
    ...
    }, re), De = (se = "collapse", le = "." + (ae = "bs.collapse"), ce = (oe = t).fn[se], fe = {
      toggle: !0,
      parent: ""
    }, he = {
      toggle: "boolean",
      ...
      return e.toggle = function () {
        ...
        if (!this._isTransitioning && !oe(this._element).hasClass(de) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(ye)).filter(function (e) {
            return "string" == typeof n._config.parent ? e.getAttribute("data-parent") === n._config.parent : e.classList.contains(pe)
          })).length && (e = null), !(e && (t = oe(e).not(this._selector).data(ae)) && t._isTransitioning))) {
          var i = oe.Event(ue.SHOW);
          if (oe(this._element).trigger(i), !i.isDefaultPrevented()) {
            ...
            oe(this._element).one(we.TRANSITION_END, function () {
              oe(n._element).removeClass(me).addClass(pe).addClass(de), n._element.style[r] = "", n.setTransitioning(!1), oe(n._element).trigger(ue.SHOWN)
        ...
        if (!this._isTransitioning && oe(this._element).hasClass(de)) {
          ...
          if (oe(this._element).trigger(t), !t.isDefaultPrevented()) {
            ...
            oe(this._element).one(we.TRANSITION_END, function () {
              e.setTransitioning(!1), oe(e._element).removeClass(me).addClass(pe).trigger(ue.HIDDEN)
        ...
        return (e = l({}, fe, e)).toggle = Boolean(e.toggle), we.typeCheckConfig(se, e, he), e
        ...
        return this.each(function () {
          var e = oe(this),
            t = e.data(ae),
            n = l({}, fe, e.data(), "object" == typeof i && i ? i : {});
    ...
    }(), oe(document).on(ue.CLICK_DATA_API, Ee, function (e) {
    ...
    }, be), Ie = "undefined" != typeof window && "undefined" != typeof document, Ae = ["Edge", "Trident", "Firefox"], Oe = 0, Ne = 0; Ne < Ae.length; Ne += 1)
    if (Ie && 0 <= navigator.userAgent.indexOf(Ae[Ne])) {
      Oe = 1;
      break
    } var ke = Ie && window.Promise ? function (e) {
    var t = !1;
    return function () {
  ...
  function Ke(e, t, n, i) {
    return Math.max(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], Fe(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
  }

  function Qe(e) {
    var t = e.body,
      n = e.documentElement,
      i = Fe(10) && getComputedStyle(n);
    return {
      height: Ke("Height", t, n, i),
      width: Ke("Width", t, n, i)
    }
  }
  var Ye = function () {
      function i(e, t) {
  ...
  function Je(e) {
    ...
    var r = {
      ...
      o = "HTML" === e.nodeName ? Qe(e.ownerDocument) : {},
    ...
    if (l || c) {
      var f = Pe(e);
      l -= qe(f, "x"), c -= qe(f, "y"), r.width -= l, r.height -= c
    }
    return Ge(r)
  }
  ...
  var wt = {
          ...
          fn: function (e, i) {
            ...
            var c = i.priority,
              ...
              h = {
                primary: function (e) {
                  var t = f[e];
                  return f[e] < l[e] && !i.escapeWithReference && (t = Math.max(f[e], l[e])), Ve({}, e, t)
                },
                secondary: function (e) {
                  var t = "right" === e ? "left" : "top",
                    n = f[t];
                  return f[e] > l[e] && !i.escapeWithReference && (n = Math.min(f[t], l[e] - ("right" === e ? f.width : f.height))), Ve({}, t, n)
                }
              };
        ...
        arrow: {
          ...
          fn: function (e, t) {
            ...
            var r = e.placement.split("-")[0],
              ...
              d = l ? "bottom" : "right",
              p = nt(i)[c];
            a[d] - p < s[h] && (e.offsets.popper[h] -= s[h] - (a[d] - p)), a[h] + p > s[d] && (e.offsets.popper[h] += a[h] + p - s[d]), e.offsets.popper = Ge(e.offsets.popper);
            var m = a[h] + a[c] / 2 - p / 2,
              g = Pe(e.instance.popper),
              _ = parseFloat(g["margin" + f], 10),
              v = parseFloat(g["border" + f + "Width"], 10),
              y = m - e.offsets.popper[h] - _ - v;
            return y = Math.max(Math.min(s[c] - p, y), 0), e.arrowElement = i, e.offsets.arrow = (Ve(n = {}, h, Math.round(y)), Ve(n, u, ""), n), e
          },
          element: "[x-arrow]"
        },
        flip: {
          ...
          fn: function (p, m) {
            ...
            return E.forEach(function (e, t) {
              ...
              var n, i = p.offsets.popper,
                ...
                c = o(i.top) < o(g.top),
                f = o(i.bottom) > o(g.bottom),
                h = "left" === _ && a || "right" === _ && l || "top" === _ && c || "bottom" === _ && f,
                u = -1 !== ["top", "bottom"].indexOf(_),
                d = !!m.flipVariations && (u && "start" === y && a || u && "end" === y && l || !u && "start" === y && c || !u && "end" === y && f);
              (s || h || d) && (p.flipped = !0, (s || h) && (_ = E[t + 1]), d && (y = "end" === (n = y) ? "start" : "start" === n ? "end" : n), p.placement = _ + (y ? "-" + y : ""), p.offsets.popper = ze({}, p.offsets.popper, rt(p.instance.popper, p.offsets.reference, p.placement)), p = st(p.instance.modifiers, p, "flip"))
            }), p
          },
          behavior: "flip",
          padding: 5,
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            var s = void 0 !== o ? o : t.gpuAcceleration,
              ...
              p = void 0,
              m = void 0;
            if (m = "bottom" === h ? "HTML" === a.nodeName ? -a.clientHeight + f.bottom : -l.height + f.bottom : f.top, p = "right" === u ? "HTML" === a.nodeName ? -a.clientWidth + f.right : -l.width + f.right : f.left, s && d) c[d] = "translate3d(" + p + "px, " + m + "px, 0)", c[h] = 0, c[u] = 0, c.willChange = "transform";
            else {
              var g = "bottom" === h ? -1 : 1,
                _ = "right" === u ? -1 : 1;
              c[h] = m * g, c[u] = p * _, c.willChange = h + ", " + u
            }
            var v = {
    ...
    Ct = function () {
      ...
      return Ye(o, [{
        ...
        value: function () {
          return function () {
            this.state.eventsEnabled || (this.state = ft(this.reference, this.options, this.state, this.scheduleUpdate))
          }.call(this)
        }
      }, {
  ...
  var Tt, St, Dt, It, At, Ot, Nt, kt, xt, Pt, Lt, jt, Ht, Mt, Ft, Wt, Rt, Ut, Bt, qt, Kt, Qt, Yt, Vt, zt, Gt, Jt, Zt, Xt, $t, en, tn, nn, rn, on, sn, an, ln, cn, fn, hn, un, dn, pn, mn, gn, _n, vn, yn, En, bn, wn, Cn, Tn, Sn, Dn, In, An, On, Nn, kn, xn, Pn, Ln, jn, Hn, Mn, Fn, Wn, Rn, Un, Bn, qn, Kn, Qn, Yn, Vn, zn, Gn, Jn, Zn, Xn, $n, ei, ti, ni, ii, ri, oi, si, ai, li, ci, fi, hi, ui, di, pi, mi, gi, _i, vi, yi, Ei, bi, wi, Ci, Ti, Si, Di, Ii, Ai, Oi, Ni, ki, xi, Pi, Li, ji, Hi, Mi, Fi, Wi, Ri, Ui, Bi = (St = "dropdown", It = "." + (Dt = "bs.dropdown"), At = ".data-api", Ot = (Tt = t).fn[St], Nt = new RegExp("38|40|27"), kt = {
      HIDE: "hide" + It,
      HIDDEN: "hidden" + It,
      SHOW: "show" + It,
      SHOWN: "shown" + It,
      CLICK: "click" + It,
      CLICK_DATA_API: "click" + It + At,
      KEYDOWN_DATA_API: "keydown" + It + At,
      KEYUP_DATA_API: "keyup" + It + At
      ...
      return e.toggle = function () {
        ...
        Tt.removeData(this._element, Dt), Tt(this._element).off(It), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
      }, e.update = function () {
    ...
    qi = (en = "modal", nn = "." + (tn = "bs.modal"), rn = ($t = t).fn[en], on = {
    ...
    }, ln = "modal-scrollbar-measure", cn = "modal-backdrop", fn = "modal-open", hn = "fade", un = "show", dn = ".modal-dialog", pn = '[data-toggle="modal"]', mn = '[data-dismiss="modal"]', gn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", _n = ".sticky-top", vn = function () {
      function r(e, t) {
      ...
      return e.toggle = function (e) {
        ...
        if (!this._isTransitioning && !this._isShown) {
          ...
          $t(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), $t(document.body).addClass(fn), this._setEscapeEvent(), this._setResizeEvent(), $t(this._element).on(an.CLICK_DISMISS, mn, function (e) {
            return t.hide(e)
        ...
        if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
          ...
          if ($t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
            this._isShown = !1;
            var i = $t(this._element).hasClass(hn);
            if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), $t(document).off(an.FOCUSIN), $t(this._element).removeClass(un), $t(this._element).off(an.CLICK_DISMISS), $t(this._dialog).off(an.MOUSEDOWN_DISMISS), i) {
        ...
        var t = this,
          n = $t(this._element).hasClass(hn);
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && we.reflow(this._element), $t(this._element).addClass(un), this._config.focus && this._enforceFocus();
        ...
        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function () {
          $t(document.body).removeClass(fn), e._resetAdjustments(), e._resetScrollbar(), $t(e._element).trigger(an.HIDDEN)
        })
      }, e._removeBackdrop = function () {
        this._backdrop && ($t(this._backdrop).remove(), this._backdrop = null)
      }, e._showBackdrop = function (e) {
        var t = this,
          n = $t(this._element).hasClass(hn) ? hn : "";
        if (this._isShown && this._config.backdrop) {
          if (this._backdrop = document.createElement("div"), this._backdrop.className = cn, n && this._backdrop.classList.add(n), $t(this._backdrop).appendTo(document.body), $t(this._element).on(an.CLICK_DISMISS, function (e) {
            ...
            }), n && we.reflow(this._backdrop), $t(this._backdrop).addClass(un), !e) return;
          if (!n) return void e();
          ...
          $t(this._backdrop).removeClass(un);
          var r = function () {
    ...
    Ki = (En = "tooltip", wn = "." + (bn = "bs.tooltip"), Cn = (yn = t).fn[En], Tn = "bs-tooltip", Sn = new RegExp("(^|\\s)" + Tn + "\\S+", "g"), An = {
      animation: !0,
    ...
    Qi = (Bn = "popover", Kn = "." + (qn = "bs.popover"), Qn = (Un = t).fn[Bn], Yn = "bs-popover", Vn = new RegExp("(^|\\s)" + Yn + "\\S+", "g"), zn = l({}, Ki.Default, {
      ...
      return r.isWithContent = function () {
        ...
        return this.each(function () {
          ...
          if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), Un(this).data(qn, e)), "string" == typeof n)) {
            if ("undefined" == typeof e[n]) throw new TypeError('No method named "' + n + '"');
            e[n]()
          }
        })
    ...
    Yi = (ii = "scrollspy", oi = "." + (ri = "bs.scrollspy"), si = (ni = t).fn[ii], ai = {
    ...
    }, fi = "dropdown-item", hi = "active", ui = '[data-spy="scroll"]', di = ".active", pi = ".nav, .list-group", mi = ".nav-link", gi = ".nav-item", _i = ".list-group-item", vi = ".dropdown", yi = ".dropdown-item", Ei = ".dropdown-toggle", bi = "offset", wi = "position", Ci = function () {
      function n(e, t) {
        var n = this;
      ...
      return e.refresh = function () {
        ...
        n.hasClass(fi) ? (n.closest(vi).find(Ei).addClass(hi), n.addClass(hi)) : (n.addClass(hi), n.parents(pi).prev(mi + ", " + _i).addClass(hi), n.parents(pi).prev(gi).children(mi).addClass(hi)), ni(this._scrollElement).trigger(ci.ACTIVATE, {
          relatedTarget: t
        })
      }, e._clear = function () {
        var e = [].slice.call(document.querySelectorAll(this._selector));
        ni(e).filter(di).removeClass(hi)
      }, n._jQueryInterface = function (t) {
        return this.each(function () {
      ...
      for (var e = [].slice.call(document.querySelectorAll(ui)), t = e.length; t--;) {
        var n = ni(e[t]);
    ...
    Vi = (Di = "." + (Si = "bs.tab"), Ii = (Ti = t).fn.tab, Ai = {
      HIDE: "hide" + Di,
      HIDDEN: "hidden" + Di,
      SHOW: "show" + Di,
      SHOWN: "shown" + Di,
    ...
    }(), Ti(document).on(Ai.CLICK_DATA_API, Fi, function (e) {
      ...
      return Ti.fn.tab = Ii, Ui._jQueryInterface
    }, Ui);
  ! function (e) {
