...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    if ($theme === 'lite') {
        $logo.attr('src', 'assets/dashboard/images/logo.png');
        $body.removeClass('theme-dark theme-semidark');
        $themeStylesheet.href = 'assets/dashboard/css/' + $theme + '-' + $style + '.min.css';
    } else if ($theme === 'dark') {
        $logo.attr('src', 'assets/dashboard/images/logo-white.png');
        $body.removeClass('theme-semidark').addClass('theme-dark');
        $themeStylesheet.href = 'assets/dashboard/css/' + $theme + '-style-1.min.css';
        $('#theme-style-chooser').hide();
    } else if ($theme === 'semidark') {
        $body.find('.dt-header .dt-brand__logo-img').attr('src', 'assets/dashboard/images/logo-white.png');
        $body.find('.dt-login__content-inner .dt-brand__logo-img').attr('src', 'assets/dashboard/images/logo.png');
